...
model = Sequential()
model.add(LSTM(256, return_sequences=False, stateful=True, batch_input_shape=(config['batch_size'], MEMORY, CATEGORIES), input_shape=(MEMORY, CATEGORIES)))   # no dropout, basically trying to overfit
